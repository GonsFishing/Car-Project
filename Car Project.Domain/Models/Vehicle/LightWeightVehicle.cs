...
namespace Car_Project.Domain.Models.Vehicle
{
	public class LightWeightVehicle : IVehicle
	{
		...
		public LightWeightVehicle(string registrationNumber, string model, string brand, float weight)
		{
		...
		public LightWeightVehicle(string registrationNumber, string model, string brand, float weight, DateTime firstTimeInTraffic, IVehicleService bookedService, List<IVehicleService> serviceHistory)
		{
			this.registrationNumber = registrationNumber;
			this.model = model;
			this.brand = brand;
