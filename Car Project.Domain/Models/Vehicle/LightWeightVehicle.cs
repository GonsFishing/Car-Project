...
{
	public class LightWeightVehicle : IVehicle
	{
		...
		private IList<IVehicleRepairService> serviceHistory { get; set; } = new List<IVehicleRepairService>();
		...
		public LightWeightVehicle(string registrationNumber, string model, string brand, float weight, string vehicleType)
		{
		...
		public LightWeightVehicle(string registrationNumber, string model, string brand, float weight, string vehicleType, DateTime firstTimeInTraffic, List<IVehicleRepairService> serviceHistory)
		{
			this.registrationNumber = registrationNumber;
			this.model = model;
			this.brand = brand;
